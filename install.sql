...
CREATE TABLE `snakr_log` (
  ...
  `cli_ip_address_id` bigint(20) NOT NULL,
  `cli_geo_lat` decimal(10,8) NOT NULL,
  `cli_geo_long` decimal(11,8) NOT NULL,
  `cli_geo_city_id` bigint(20) NOT NULL,
  `cli_geo_country_id` bigint(20) NOT NULL,
  `cli_http_host_id` bigint(20) NOT NULL,
  `cli_http_user_agent_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

CREATE UNIQUE INDEX `ui_exportkey` ON `snakr_log`(`logged_on`, `entry_type`,`id`);
CREATE UNIQUE INDEX `ui_longurl_id` ON `snakr_log`(`longurl_id`,`id`);
CREATE UNIQUE INDEX `ui_shorturl_id` ON `snakr_log`(`shorturl_id`,`id`);

CREATE TABLE `snakr_log_cli_ip_address` (
  `id` bigint(20) NOT NULL,
  `cli_ip_address` binary(128) NOT NULL,  
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `snakr_log_cli_geo_city` (
  `id` bigint(20) NOT NULL,
  `cli_geo_city` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `snakr_log_cli_geo_city` (
  `id` ,
  `cli_geo_city` 
)
VALUES (
...
CREATE TABLE `snakr_log_cli_geo_country` (
  `id` bigint(20) NOT NULL,
  `cli_geo_country` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `snakr_log_cli_geo_country` (
  `id` ,
  `cli_geo_country` 
)
VALUES (
...
CREATE TABLE `snakr_log_cli_http_host` (
  `id` bigint(20) NOT NULL,
  `cli_http_host` varchar(253) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `snakr_log_cli_http_host` (
  `id` ,
  `cli_http_host` 
)
VALUES (
...
CREATE TABLE `snakr_log_cli_http_user_agent` (
  `id` bigint NOT NULL,
  `cli_http_user_agent` VARCHAR(8192) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `snakr_log_cli_http_user_agent` (
  `id` ,
  `cli_http_user_agent` 
)
VALUES (
...
CREATE TABLE `snakr_log_messages` (
