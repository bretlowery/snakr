    ...
    def __init__(self, *args, **kwargs):
        ...
        if settings.ENABLE_BOTPROTECTION:
            ...
            self._known_bots = ['1job', 'abot', 'agentname', 'apachebench', 'aport', 'applesyndication', 'ask jeeves', 'ask+jeeves',
                                ...
                                'moreoverbot', 'webbot', 'search_comments\\at\\sensis\\dot\\com\\dot\\au', 'panscient.com', 'snoopy',
                                ...
                                '(simulated_by_webserver_stress_tool)', 'wapt', 'updatepatrol', 'sitecon', 'bingbot', 'www-mechanize',
