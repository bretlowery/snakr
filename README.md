...
cli_http_user_agent_id   | BIGINT                   | 64-bit integer version of the hexdigest of the SHA1 hash of a USER_AGENT stored in snakr_useragents. Could be useful for forensic cluster analysis for fraud or abuse patterns in the log.
