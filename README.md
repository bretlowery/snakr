...
------------------ | ------------------------ | ------------
id (PK)            | BIGINT                   | 64-bit integer version of the hexdigest of the SHA1 hash of the quoted, utf8-encoded long URL. It's more efficient to lookup a long url using an integer key rather than comparing to the full VARCHAR long url.
...
Column             | Datatype (all NOT NULL)  | Description
------------------ | ------------------------ | ------------
id (PK)            | BIGINT                   | 64-bit integer version of the hexdigest of the SHA1 hash of the UNquoted, utf8-encoded short URL. It's more efficient to lookup a short url using an integer key rather than comparing to the full VARCHAR short url.
...
cli_http_host_hash       | BIGINT                   | 64-bit integer version of the hexdigest of the SHA1 hash of cli_http_host. Could be useful for forensic cluster analysis for fraud or abuse patterns in the log.  NOT CURRENTLY IMPLEMENTED.
...
cli_http_referrer_hash   | BIGINT                   | 64-bit integer version of the hexdigest of the SHA1 hash of cli_http_referrer. Could be useful for forensic cluster analysis for fraud or abuse patterns in the log.  NOT CURRENTLY IMPLEMENTED.
...
cli_http_user_agent_hash | BIGINT                   | 64-bit integer version of the hexdigest of the SHA1 hash of cli_http_host. Could be useful for forensic cluster analysis for fraud or abuse patterns in the log.  NOT CURRENTLY IMPLEMENTED.
